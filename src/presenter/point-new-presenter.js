...
//? не дает выбрать тип точки маршрута. Вообще поработать с формой новой точки. Чего-то datapicker перестал работать - только в новой точке. В редактировании работает.
//? Длительность поездки в часах считает как-то криво
...
export default class PointNewPresenter extends AbstractView {
	...
	_changeModeToView() {
		this.destroy();	// replace(this._pointComponent, this._pointEditorComponent);
